WOA_to_PPOX_MONTH <- function ( LATITUDE, LONGITUDE, MONTH ){

# This routine is dedicated to estimate PPOX at surface from the World Ocean Atlas Database but on a monthly basis to check the seasonal variation
#
...
file_in_WOA_satO2=paste("/home/schmechtig/TRAITEMENT_FLOTTEUR/ANTOINE/DATA_MANAGEMENT/CLIMATOLOGY/MONTHLY/woa13_all_O",MONTH,"_01.nc",sep="")
file_in_WOA_temp=paste("/home/schmechtig/TRAITEMENT_FLOTTEUR/ANTOINE/DATA_MANAGEMENT/CLIMATOLOGY/MONTHLY/woa13_decav_t",MONTH,"_01v2.nc",sep="")
file_in_WOA_psal=paste("/home/schmechtig/TRAITEMENT_FLOTTEUR/ANTOINE/DATA_MANAGEMENT/CLIMATOLOGY/MONTHLY/woa13_decav_s",MONTH,"_01v2.nc",sep="")
